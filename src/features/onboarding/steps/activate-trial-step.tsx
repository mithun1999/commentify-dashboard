  ...
  comment: {
    starter: {
      ...
      features: [
        ...
        'Up to 900 comments per month',
        'Monitor up to 10 specific profiles',
        'Up to 450 sales mentions per month',
    ...
    pro: {
      ...
      features: [
        ...
        'Up to 2,400 comments per month',
        'Monitor up to 30 specific profiles',
        'Up to 1,200 sales mentions per month',
        'Advanced targeting — geography, author titles & engagement',
